...
- **Linux:** Riff is built from source; choose acceleration for the environment where you build.
...
This guide helps you build Riff on Linux with **automatic GPU acceleration**. The build system detects your hardware and configures the best performance automatically.
...
```
src-tauri/target/release/bundle/appimage/Riff_<version>_amd64.AppImage
```
