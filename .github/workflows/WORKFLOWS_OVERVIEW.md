...
- Artifacts prefixed with `riff-test-`
...
```
riff-{workflow}-{platform}-{target}-{version}
```

**Examples:**
- `riff-devtest-macOS-aarch64-apple-darwin-0.1.3`
- `riff-test-windows-x86_64-pc-windows-msvc-0.1.3`
- `riff-macos-aarch64-release-0.1.3`
