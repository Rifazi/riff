# GPU-accelerated development script for Riff (Windows PowerShell)
# Automatically detects and runs in development mode with optimal GPU features

Write-Host "GPU-Accelerated Development Mode for Riff" -ForegroundColor Blue
Write-Host ""
...
Write-Host ""
Write-Host "Starting Riff in development mode..." -ForegroundColor Blue
Write-Host ""
