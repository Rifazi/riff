...
const TRANSCRIPTION_RUNTIME_USER_MESSAGE: &str = "Speech recognition could not initialize. Restart Riff. If the problem continues, repair or reinstall the app.";
