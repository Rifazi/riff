@echo off
REM Riff Build Script for Windows
...
echo 🚀 Building Riff application...
...
echo.
echo DESCRIPTION:
echo   This script builds the Riff Tauri application for Windows.
